...
fun Fragment.resChildString(@StyleRes id: Int, @AttrRes childId: Int, vararg format: Any?) =
...
fun Fragment.resChildDimensionPixelOffset(@StyleRes id: Int, @AttrRes childId: Int, defValue: Int) =
...
fun View.resChildText(@StyleRes id: Int, @AttrRes childId: Int) =
    context.resChildText(id, childId)

fun View.resChildString(@StyleRes id: Int, @AttrRes childId: Int) =
    context.resChildString(id, childId)

fun View.resChildString(@StyleRes id: Int, @AttrRes childId: Int, vararg format: Any?) =
...
fun View.resChildDimensionPixelOffset(@StyleRes id: Int, @AttrRes childId: Int, defValue: Int) =
    context.resChildDimensionPixelOffset(id, childId, defValue)

fun View.resChildDimensionPixelSize(@StyleRes id: Int, @AttrRes childId: Int, defValue: Int) =
...
@RequiresApi(Build.VERSION_CODES.O)
fun View.resChildFont(@StyleRes id: Int, @AttrRes childId: Int) =
    context.resChildFont(id, childId)
