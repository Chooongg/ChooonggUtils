...
fun Context.attrChildText(
    @AttrRes id: Int, @AttrRes childId: Int
): CharSequence? = with(TypedValue()) {
    theme.resolveAttribute(id, this, true)
    obtainStyledAttributes(resourceId, intArrayOf(childId)).use { it.getText(0) }
}

fun Context.attrChildString(
    @AttrRes id: Int, @AttrRes childId: Int
) = with(TypedValue()) {
    theme.resolveAttribute(id, this, true)
...
fun Context.attrChildString(
    @AttrRes id: Int, @AttrRes childId: Int, vararg format: Any?
) = with(TypedValue()) {
    theme.resolveAttribute(id, this, true)
...
fun Context.attrChildBoolean(
    @AttrRes id: Int, @AttrRes childId: Int, defValue: Boolean
) = with(TypedValue()) {
    theme.resolveAttribute(id, this, true)
    obtainStyledAttributes(resourceId, intArrayOf(childId)).use { it.getBoolean(0, defValue) }
}

fun Context.attrChildInt(
    @AttrRes id: Int, @AttrRes childId: Int, defValue: Int
) = with(TypedValue()) {
    theme.resolveAttribute(id, this, true)
    obtainStyledAttributes(resourceId, intArrayOf(childId)).use { it.getInt(0, defValue) }
}

fun Context.attrChildFloat(
    @AttrRes id: Int, @AttrRes childId: Int, defValue: Float
) = with(TypedValue()) {
    theme.resolveAttribute(id, this, true)
...
fun Context.attrChildColorStateList(
    @AttrRes id: Int, @AttrRes childId: Int
) = with(TypedValue()) {
    theme.resolveAttribute(id, this, true)
...
fun Context.attrChildDimension(
    @AttrRes id: Int, @AttrRes childId: Int, defValue: Float
) = with(TypedValue()) {
    theme.resolveAttribute(id, this, true)
...
fun Context.attrChildResourcesId(
    @AttrRes id: Int, @AttrRes childId: Int, defValue: Int
) = with(TypedValue()) {
    theme.resolveAttribute(id, this, true)
    obtainStyledAttributes(resourceId, intArrayOf(childId)).use {
