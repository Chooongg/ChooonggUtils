...
class SpannableStyle(val content: CharSequence) {
     ...
     * 追加内容对象
     */
    fun append(nextVal: SpannableStyle): SpannableStyle {
     ...
     * 追加内容文本
     */
    fun append(content: CharSequence): SpannableStyle {
        return append(SpannableStyle(content))
    }

    operator fun plus(nextVal: SpannableStyle) = append(nextVal)
